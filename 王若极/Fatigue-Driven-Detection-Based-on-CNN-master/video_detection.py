...
file_name='D:\\WorkSpace\\Fatigue-Driven-Detection-Based-on-CNN-master\\tests\\02.mp4'
cap=cv2.VideoCapture(file_name)
max_fps=0

#保存检测结果的List
#眼睛和嘴巴都是，张开为‘1’，闭合为‘0’
video_fps=29#视频fps=20
list_B=np.ones(video_fps)#眼睛状态List,建议根据fps修改，视频fps=20
...
while cap.isOpened():
	...
	cv2.putText(img,str(perclos),(0,100),cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,255,255), 1, 8)
	cv2.imshow("ssd",img)
