...
def parse_args():
    ...
    args = parser.parse_args(['--input',r'D:\\WorkSpace\\Fatigue-Driven-Detection-Based-on-CNN-master\\tests\\01.mp4','--output',r'D:\\WorkSpace\\Fatigue-Driven-Detection-Based-on-CNN-master\\tests\\splited'])
    return args
