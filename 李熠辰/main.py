...
parser.add_argument('--plm_name', type=str, default='deberta-large')
...
parser.add_argument('--FacialEmoImpor_threshold', type=float, default=0.7,
...
parser.add_argument('--crossmodal_attn_dropout_TA_V', type=float, default=0.9, help='dropout applied on the attention weights')
...
parser.add_argument('--choice', type=str, default='1')
...
parser.add_argument('--load_multimodal_path', type=str, default= 'multimodal_model_T+A+V_DeBERTa.pt', 
                    help='path to load the best multimodal to evaluate on the test set')
parser.add_argument('--load_swin_path', type=str, default= 'best_swin_DeBERTa.pt',
...
#     args.audio_featExtr_dim = trg_train_data.get_audio_featExtr_dim()  
      args.audio_featExtr_dim = trg_test_data.get_audio_featExtr_dim()  

if args.choice_modality in ('V', 'T+A+V'):
#     args.vision_featExtr_dim = trg_train_data.get_vision_featExtr_dim()
      args.vision_featExtr_dim = trg_test_data.get_vision_featExtr_dim()
